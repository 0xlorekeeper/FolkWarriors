...
contract Blacksmith is Initializable, AccessControlUpgradeable {
    ...
    //leovicio
    uint256 public SHIELD_SKILL_FEE;
    ...
    function migrateTo_16884dd(
        ...
        itemFlatPrices[ITEM_CHARACTER_TRAITCHANGE_FIRE] = 0.4 ether;
        itemFlatPrices[ITEM_CHARACTER_TRAITCHANGE_EARTH] = 0.4 ether;
        itemFlatPrices[ITEM_CHARACTER_TRAITCHANGE_WATER] = 0.4 ether;
        itemFlatPrices[ITEM_CHARACTER_TRAITCHANGE_LIGHTNING] = 0.4 ether;
    }
    ...
    //SHIELD leovicio
    function setShieldPrice(uint256 newPrice) external isAdmin {
        require(newPrice > 0, 'invalid price');
        SHIELD_SKILL_FEE = newPrice;
    }
}
